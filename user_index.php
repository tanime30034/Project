...
include("php/dbconnection.php");
    ...
    // Fetch pet names and photo paths from the pets table
    $sql = "SELECT petID, name, photoPath FROM pets WHERE status='Available'";
    ...
    <section class="py-5">
        <div class="container text-center">
            ...
            <div class="row justify-content-center mt-3">
                ...
                <a href="adopt.php" style="text-decoration: none;">
                    <div class="card">
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <a href="lost-found.html" style="text-decoration: none;">
                    <div class="card">
                        <img src="images/adopt_process_2.jpg" alt="Pet 2" class="card-img-top" style="height: 200px; object-fit: cover;">
                        <div class="card-body bg-purple text-black text-center">
                            <h4>Find Your Pet</h4>
                        </div>
                    </div> 
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card">
                        <img src="images/adopt_process_3.jpg" alt="Pet 3" class="card-img-top" style="height: 200px; object-fit: cover;">
                        <div class="card-body bg-purple text-black text-center">
                            <h4>Pet Care</h4>
                        </div>
                    </div>
                ...
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card">
                        <img src="images/pet_foodz.jpg" alt="Pet 3" class="card-img-top" style="height: 200px; object-fit: cover;">
                        <div class="card-body bg-purple text-black text-center">
                            <h4>Pet Products</h4>
                        </div>
                    </div>
